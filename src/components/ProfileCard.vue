<script setup lang="ts">
    ...
    let displayedMessage = ref("Heya! I am Threona, a wander gamer that likes messing around with code, games and arts.");
    const messageList = [
        "My first program was a Tic-tac-toe game with Console Rendering.",
        "My fav programming language is C#!",
        "I love open source software, knowing how all the stuff you use works is important!",
        "Fried Chicken is good but my fingers will sticky all day...",
        ...
        "Dynasty Warrior is one of my favourite games!",
...
<template>
    <button v-on:click="randomizeMessage" class="profile window full-w flex g-x p-x">
        <img src="/src/assets/img/pixelAva.png" class="profile__image full-h" alt="Github profile">
